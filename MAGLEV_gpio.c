...
void InitGPIO(void)
{
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO6      = 0;        // 0=GPIO               1=EPWM3B     2=SPISIMOA   3=ECAP1
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO7      = 0;        // 0=GPIO               1=EPWM3B     2=SPISIMOA   3=ECAP1
    GpioCtrlRegs.GPAQSEL1.bit.GPIO7     = 0;        // No qualification for all group A GPIO 0-15
    GpioCtrlRegs.GPADIR.bit.GPIO7       = 1;        // 0 - Input ; 1 - Output;
    GpioCtrlRegs.GPAPUD.bit.GPIO7       = 1;        // 0-Pullup enabled, 1-Pullup disabled
